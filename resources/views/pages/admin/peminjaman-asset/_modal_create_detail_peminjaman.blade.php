<div class="modal fade modalCreateDetailPeminjaman" id="modalDetailPemutihan" role="dialog" aria-labelledby=""
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form class="kt-form kt-form--fit kt-form--label-right form-submit" action="{{ route('admin.peminjaman.detail-asset.store-many') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <select name="id_kategori_asset" onchange="filterTableAsset()" class="form-control ml-3" style="width: 200px" id="kategoriAssetFilter">
                                @foreach ($peminjaman->request_peminjaman_asset as $item)
                                    <option value="{{ $item->id_kategori_asset }}">{{ $item->kategori_asset->nama_kategori }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>

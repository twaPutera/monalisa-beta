<div class="modal fade modalEditDetailInventaris" id="modalEditDetailInventaris" role="dialog" aria-labelledby=""
    aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            <select name="id_lokasi" class="form-control selectLokasi" id="selectLokasiEdit">
